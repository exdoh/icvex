...
<div id="about_container" class="container">
  ...
  <div class="row">
    ...
    <div id="about_banner-info" class="col-xs-8 bg-red">
      ...
      <h3>1-3 October 2014</h3>
      <h4>09.00-17.00 hrs. (Wed. 1 - Thu. 2 Oct 2014)</h4>
      <h4>09.00-16.00 hrs. (Fri. 3 Oct 2014)</h4>
      <p>
  ...
  <div id="about_why-autoplus" class="row">
    <h1>Why Myanmar Auto Plus?</h1>
    <div class="col-xs-4">
      <ul>
        <li><h3>Business platform for trade professionals in the industry of automotive, auto parts, components and accessories</h3></li>
      </ul>
    </div>
    <div class="col-xs-4">
      <ul>
  ...
  <div id="about_icvex-info" class="row">
    ...
    <div class="col-xs-6">
      <h3>ICVeX</h3>
      <p>Myanmar Auto Plus is organized by ICVeX, the subsidiary company of Index Creative Village which is well known as world’s 7th ranking event company. With highly experienced management team and extensive business network in Myanmar including local office in Yangon, we are confident in delivering high quality exhibition with great return on investment for all exhibiting companies</p>
    </div>
  </div>
  <!-- Fourth Row -->
</div>
