...
<div id="about_container" class="container">
  ...
  <div class="row">
    ...
    <div id="about_banner-info" class="col-xs-8 bg-red">
      ...
      <h3>2-4 July 2014</h3>
      <h4>09.00-17.00 hrs. (Wed 2- Thu3 July 2014)</h4>
      <h4>09.00-16.00hrs. (Friday 4 July, 2014)</h4>
      <p>
  ...
  <div id="about_why-autoplus" class="row">
    <h1>Why Myanmar HoReCa 2014?</h1>
    <div class="col-xs-4">
      <ul>
        <li><h3>Meeting with professionals from the business of hotels, restaurants and catering in Myanmar</h3></li>
      </ul>
    </div>
    <div class="col-xs-4">
      <ul>
    ...
    <div class="col-xs-4">
      <ul>
        <li><h3>The venue is located at the center of Yangon with international standard</h3></li>
      </ul>
    </div>
  </div>
  <!-- Second Row -->
  ...
  <div id="about_icvex-info" class="row">
    ...
    <div class="col-xs-6">
      <h3>ICVeX</h3>
      <p>Myanmar HoReCa is organized by ICVeX, the subsidiary company of Index Creative Village which is well known as world’s 7th ranking event company. With highly experienced management team and extensive business network in Myanmar including local office in Yangon, we are confident in delivering high quality exhibition with great return on investment for all exhibiting companies</p>
    </div>
  </div>
  <!-- Fourth Row -->
</div>
